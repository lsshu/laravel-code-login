 ...
 */
?>
@extends('logins::layouts.main',['title'=>'登录'])
@section('style')
    <style>
        .container{
            text-align: center;
                        ...
                        that.request('{{$check_login ?? ''}}').then(function (Msg) {
                            try{
                                if(Msg.status == 'success'){
                                    ...
                                    if(Msg.code_status){
                                        var code_status = document.getElementById('code_status');
                                        code_status.innerText = Msg.code_title;
                                        code_status.style.color = 'green';
                                    }
